...
public class DataComponentTypes {
    ...
    public static final IntComponentType CUSTOM_MODEL_DATA = register(id -> new IntComponentType(id, "custom_model_data", MinecraftTypes::readVarInt, MinecraftTypes::writeVarInt, IntDataComponent::new));
    ...
    public static final DataComponentType<MNBT> INTANGIBLE_PROJECTILE = register(id -> new DataComponentType<>(id, "intangible_projectile", MinecraftTypes::readMNBT, MinecraftTypes::writeMNBT, ObjectDataComponent::new));
    ...
    public static final DataComponentType<Unit> FIRE_RESISTANT = register(id -> new DataComponentType<>(id, "fire_resistant", unitReader(), unitWriter(), ObjectDataComponent::new));
