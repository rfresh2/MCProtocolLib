...
public class PlayerListEntry {
    ...
    public PlayerListEntry(UUID profileId) {
        this(profileId, new GameProfile(profileId, null), true, 0, GameMode.SURVIVAL, null, false, 0, null, 0, null, null);
    }

    public PlayerListEntry(String name, UUID profileId) {
        this(profileId, new GameProfile(profileId, name), true, 0, GameMode.SURVIVAL, null, false, 0, null, 0, null, null);
    }
