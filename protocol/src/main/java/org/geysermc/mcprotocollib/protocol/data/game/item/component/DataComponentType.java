...
public class DataComponentType<T> {
    ...
    public static final DataComponentType<String> ITEM_MODEL = new DataComponentType<>(ItemCodecHelper::readResourceLocationString, ItemCodecHelper::writeResourceLocation, ObjectDataComponent::new);
    ...
    public static final DataComponentType<String> DAMAGE_RESISTANT = new DataComponentType<>(ItemCodecHelper::readResourceLocationString, ItemCodecHelper::writeResourceLocation, ObjectDataComponent::new);
    ...
    public static final DataComponentType<String> TOOLTIP_STYLE = new DataComponentType<>(ItemCodecHelper::readResourceLocationString, ItemCodecHelper::writeResourceLocation, ObjectDataComponent::new);
    ...
    public static final DataComponentType<String> NOTE_BLOCK_SOUND = new DataComponentType<>(ItemCodecHelper::readResourceLocationString, ItemCodecHelper::writeResourceLocation, ObjectDataComponent::new);
    ...
    public static final DataComponentType<MNBT> LOCK = new DataComponentType<>(ItemCodecHelper::readMNBT, ItemCodecHelper::writeMNBT, ObjectDataComponent::new);
