...
public class DataComponentType<T> {
    ...
    public static final DataComponentType<MNBT> CUSTOM_DATA = new DataComponentType<>("custom_data", MinecraftTypes::readMNBT, MinecraftTypes::writeMNBT, ObjectDataComponent::new);
    ...
    public static final DataComponentType<MNBT> INTANGIBLE_PROJECTILE = new DataComponentType<>("intangible_projectile", MinecraftTypes::readMNBT, MinecraftTypes::writeMNBT, ObjectDataComponent::new);
    ...
    public static final DataComponentType<String> DAMAGE_RESISTANT = new DataComponentType<>("damage_resistant", MinecraftTypes::readResourceLocationString, MinecraftTypes::writeResourceLocation, ObjectDataComponent::new);
    ...
    public static final DataComponentType<String> TOOLTIP_STYLE = new DataComponentType<>("tooltip_style", MinecraftTypes::readResourceLocationString, MinecraftTypes::writeResourceLocation, ObjectDataComponent::new);
    ...
    public static final DataComponentType<MNBT> DEBUG_STICK_STATE = new DataComponentType<>("debug_stick_state", MinecraftTypes::readMNBT, MinecraftTypes::writeMNBT, ObjectDataComponent::new);
    public static final DataComponentType<MNBT> ENTITY_DATA = new DataComponentType<>("entity_data", MinecraftTypes::readMNBT, MinecraftTypes::writeMNBT, ObjectDataComponent::new);
    public static final DataComponentType<MNBT> BUCKET_ENTITY_DATA = new DataComponentType<>("bucket_entity_data", MinecraftTypes::readMNBT, MinecraftTypes::writeMNBT, ObjectDataComponent::new);
    public static final DataComponentType<MNBT> BLOCK_ENTITY_DATA = new DataComponentType<>("block_entity_data", MinecraftTypes::readMNBT, MinecraftTypes::writeMNBT, ObjectDataComponent::new);
    ...
    public static final DataComponentType<ListTag> RECIPES = new DataComponentType<>("recipes", ItemTypes::readRecipes, ItemTypes::writeRecipes, ObjectDataComponent::new);
    ...
    public static final DataComponentType<MNBT> CONTAINER_LOOT = new DataComponentType<>("container_loot", MinecraftTypes::readMNBT, MinecraftTypes::writeMNBT, ObjectDataComponent::new);
