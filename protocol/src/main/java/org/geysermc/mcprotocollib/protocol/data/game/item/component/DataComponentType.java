...
public class DataComponentType<T> {
    ...
    public static final IntComponentType CUSTOM_MODEL_DATA = new IntComponentType("custom_model_data", MinecraftTypes::readVarInt, MinecraftTypes::writeVarInt, IntDataComponent::new);
    ...
    public static final DataComponentType<Unit> FIRE_RESISTANT = new DataComponentType<>("fire_resistant", unitReader(), unitWriter(), ObjectDataComponent::new);
