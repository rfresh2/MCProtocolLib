...
public class ItemCodecHelper extends MinecraftCodecHelper {
    ...
    public AdventureModePredicate readAdventureModePredicate(ByteBuf buf) throws UncheckedIOException {
    ...
    public void writeAdventureModePredicate(ByteBuf buf, AdventureModePredicate adventureModePredicate) throws UncheckedIOException {
    ...
    public AdventureModePredicate.BlockPredicate readBlockPredicate(ByteBuf buf) throws UncheckedIOException {
    ...
    public void writeBlockPredicate(ByteBuf buf, AdventureModePredicate.BlockPredicate blockPredicate) throws UncheckedIOException {
    ...
    public WrittenBookContent readWrittenBookContent(ByteBuf buf) throws UncheckedIOException {
    ...
    public void writeWrittenBookContent(ByteBuf buf, WrittenBookContent content) throws UncheckedIOException {
    ...
    public ArmorTrim readArmorTrim(ByteBuf buf) throws UncheckedIOException {
    ...
    public ListTag readRecipes(ByteBuf buf) throws UncheckedIOException {
        return this.readTag(buf, ListTag.class);
    }

    public void writeRecipes(ByteBuf buf, ListTag recipes) throws UncheckedIOException {
        this.writeTag(buf, recipes);
    }
    ...
    public BeehiveOccupant readBeehiveOccupant(ByteBuf buf) throws UncheckedIOException {
        return new BeehiveOccupant(this.readTag(buf), this.readVarInt(buf), this.readVarInt(buf));
    }

    public void writeBeehiveOccupant(ByteBuf buf, BeehiveOccupant occupant) throws UncheckedIOException {
    ...
    public StringTag readLock(ByteBuf buf) throws UncheckedIOException {
        return this.readTag(buf, StringTag.class);
    }

    public void writeLock(ByteBuf buf, StringTag key) throws UncheckedIOException {
