...
public class BooleanComponentType extends DataComponentType<Boolean> {
    ...
    @Override
    public DataComponent<Boolean, BooleanComponentType> readDataComponent(ItemCodecHelper helper, ByteBuf input) throws UncheckedIOException {
        return this.primitiveFactory.createPrimitive(this, this.primitiveReader.readPrimitive(input));
    }

    public void writeDataComponentPrimitive(ByteBuf output, boolean value) throws UncheckedIOException {
