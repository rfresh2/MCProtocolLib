...
public class DataComponentType<T> {
    ...
    public DataComponent<T, ? extends DataComponentType<T>> readDataComponent(ItemCodecHelper helper, ByteBuf input) throws UncheckedIOException {
    ...
    public void writeDataComponent(ItemCodecHelper helper, ByteBuf output, T value) throws UncheckedIOException {
        this.writer.write(helper, output, value);
    }

    @FunctionalInterface
    public interface Reader<V> {
        V read(ItemCodecHelper helper, ByteBuf input) throws UncheckedIOException;
    }

    @FunctionalInterface
    public interface Writer<V> {
        void write(ItemCodecHelper helper, ByteBuf output, V value) throws UncheckedIOException;
    }
    ...
    public interface BasicReader<V> extends Reader<V> {
        ...
        default V read(ItemCodecHelper helper, ByteBuf input) throws UncheckedIOException {
    ...
    public interface BasicWriter<V> extends Writer<V> {
        ...
        default void write(ItemCodecHelper helper, ByteBuf output, V value) throws UncheckedIOException {
