...
public class OptionalIntMetadataType extends MetadataType<OptionalInt> {
    ...
    public static class OptionalIntReader implements Reader<OptionalInt> {
        ...
        @Override
        public OptionalInt read(MinecraftCodecHelper helper, ByteBuf input) throws UncheckedIOException {
    ...
    public static class OptionalIntWriter implements Writer<OptionalInt> {
        ...
        @Override
        public void write(MinecraftCodecHelper helper, ByteBuf output, OptionalInt value) throws UncheckedIOException {
            if (value.isPresent()) {
